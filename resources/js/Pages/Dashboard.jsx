        ...
        >
            <div className='grid place-content-center text-gray-500'>
                ...
                <div className='flex flex-row'>
                    ...
                    <button className='rounded-r-lg mb-10 bg-[#0a101e] border-[#2c3c5f]'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10">
                ...
                <table className='table-auto text-center'>
                    <thead className='bg-blue-100'>
                        <tr className='border-2'>
                            ...
                            <th className='p-3'>Seance</th>
                            <th className='p-3'>Payer Name</th>
                            <th className='p-3'>Amount</th>
                            <th className='p-3 pl-4'>Status</th>
                            <th className='p-3 pl-4'>CreatedAt</th>
                            <th className='p-3 pl-4'>Cancel Payment</th>
                        </tr>
                    </thead>
                    <tbody>
                        {props.payments.data.map((elem) => (
                            <tr className='text-gray-200 bg-[#111827]' key={elem.id}>
                                ...
                                <td className='p-1 text-center border-2'><button onClick={() => canclePayment(elem.id)} className='p-2'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 bg-red-500 rounded-full text-white">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                </button></td>
                            </tr>
