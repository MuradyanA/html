                    ...
                    <table className='table-auto text-center'>
                        <thead className='bg-blue-100'>
                            <tr className='border-2'>
                                <th className='p-2 pl-1 sm:p-4'>Id</th>
                                <th className='p-2 pl-1 sm:p-4'>Seance</th>
                                <th className='p-2 pl-1 sm:p-4'>Payer Name</th>
                                <th className='p-2 pl-1 sm:p-4'>Amount</th>
                                <th className='p-2 pl-1 sm:p-4 sm:pl-4'>Status</th>
                                <th className='p-2 pl-1 sm:p-4 sm:pl-4'>CreatedAt</th>
                        ...
                        <tbody>
                            {props.payments.data.map((elem) => (
                                <tr className='text-gray-200 bg-[#111827]' key={elem.id}>
                                    <td className='p-2  border-2'>{elem.id}</td>
                                    <td className='p-2  border-2'>{moment(elem.SeanceDate + ' ' + elem.SeanceTime).format('ddd DD-MM-YY HH:mm')}</td>
                                    <td className='p-2  border-2'>{elem.name}</td>
                                    <td className='p-2  border-2'>{Intl.NumberFormat('en-US').format(elem.amount)}</td>
                                    <td className='p-2  border-2'>{elem.status}</td>
                                    <td className='p-2  border-2'>{moment(elem.created_at).format('ddd DD-MM-YY HH:mm')}</td>
